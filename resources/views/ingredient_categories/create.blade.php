        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="max-w-3xl mx-auto p-6 bg-white border-b border-gray-200">
                    <form method="POST" action="{{ route('ingredient_categories.store') }}">
                    @csrf
                       <!-- Code -->
                        <div class="mt-4">
                        ...
                        <div class="mt-4">
                            ...
                            <x-input id="name_en" class="block mt-1 w-full" type="text" name="name" :value="old('name_en')" required autofocus />
